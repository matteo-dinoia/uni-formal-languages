...
public class Translator {
	...
	private void bexpr(int ltrue, int lfalse){
		...
		case Tag.AND:
			match(Tag.AND);
			int lcontinue=code.newLabel();
			bexpr(lcontinue, lfalse);
			code.emitLabel(lcontinue);
			bexpr(ltrue, lfalse);
			break;
		case Tag.OR:
			match(Tag.OR);
			int lcontinue2=code.newLabel();
			bexpr(ltrue, lcontinue2);
			code.emitLabel(lcontinue2);
			bexpr(ltrue, lfalse);
			break;
		case '!':
			match('!');
	...
	public static void main(String args[]) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("_5_2_translator_boolean/input.lft"));
